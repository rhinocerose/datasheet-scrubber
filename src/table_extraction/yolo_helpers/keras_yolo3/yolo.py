...
from yolo_helpers.keras_yolo3.yolo3.model import yolo_eval, yolo_body, tiny_yolo_body
from yolo_helpers.keras_yolo3.yolo3.utils import letterbox_image
import os
#from keras.utils import multi_gpu_model # Commented it because of new tensorflow version issue.
...
class YOLO(object):
    ...
    def generate(self):
        ...
        # if self.gpu_num >= 2: # Commented it because of new tensorflow version issue.
        #     self.yolo_model = multi_gpu_model(self.yolo_model, gpus=self.gpu_num) # Commented it because of new tensorflow version issue.
